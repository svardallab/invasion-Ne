...
$SCRIPT_DIR/PROGRAMMES/MANAGE_CHROMOSOMES2>>out<<@
-99
$maxNSNP
@
...
for ((n=1; n<=$NCHR; n++)); do echo $n; done | xargs -I % -P $threads bash -c "$SCRIPT_DIR/PROGRAMMES/LD_SNP_REAL3 % $options_for_LD"
...
$SCRIPT_DIR/PROGRAMMES/SUMM_REP_CHROM3>>out<<@
$NGEN	NGEN
$NBIN	NBIN
$NCHR	NCHR
@
...
$SCRIPT_DIR/PROGRAMMES/GONEparallel.sh -hc $hc outfileLD $REPS
