...
if __name__ == "__main__":
    if len(sys.argv) != 10:
        print(
            "Usage: python exponential_piecewise_nuts_contig.py <ld_file> <ne_anc_file> <ne1_prior_sd> <t0_prior_mean> <t0_prior_sd> <alpha_logfold_prior_sd> <sample_size> <seed> <output_file>"
        )
        sys.exit(1)
    ld_file = sys.argv[1]
